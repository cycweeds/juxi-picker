...
public class PickerViewLinkage extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        loopViews.add(loopViewOne);
        loopViews.add(loopViewTwo);
        loopViews.add(loopViewThree);
    }
    ...
    public void setRow(int row) {
        ...
        switch (row) {
          case 1:
                ...
                loopViewTwo.setVisibility(GONE);
    ...
    public void setTextFontSize(float fontSize) {
      for (LoopView loopView: loopViews) {
        loopView.setTextSize(fontSize);
      }
    }
  ...
  public void setTextSelectedColor(int color) {
    for (LoopView loopView: loopViews) {
      loopView.paintCenterText.setColor(color);
    }
  }
    ...
    public void setSelectValue(String[] selectValue) {
        if (numColumns <= selectValue.length) {
            String[] values = Arrays.copyOf(selectValue, numColumns);
    ...
    public void setTextColor(int color){
        switch (numColumns) {
          case 1:
            loopViewOne.paintOuterText.setColor(color);
            case 2:
              loopViewOne.paintOuterText.setColor(color);
              loopViewTwo.paintOuterText.setColor(color);
...
//                loopViewTwo.setTextColor(color);
            ...
            case 3:
              loopViewOne.paintOuterText.setColor(color);
              loopViewTwo.paintOuterText.setColor(color);
              loopViewThree.paintOuterText.setColor(color);
